...
\begin{abstract}
La retinopatía diabética es una de las mayores causas de ceguera en los países desarrollados, para determinar el grado de  anomalía, se realiza una imagen de la retina del paciente, captada por un retinógrafo. Este procedimiento, tiene un coste elevado para la sanidad pública, y además, consta de que el paciente se desplace a un centro médico.

Por ello, se han desarrollado unos dispositivos, para las cámaras de los móviles, que permiten obtener las fotografías de las retinas; de esta forma, el paciente no tendría que desplazarse a un hospital que contenga el retinógrafo y el médico de familia le realizaría la foto al paciente. 

En este trabajo, propone facilitar la labor del médico, haciendo una aplicación Android la cual realizaría un primer diagnostico del paciente a partir de una imagen que se enviará esta foto a modelos de aprendizaje computacional existentes; haciendo que los pacientes que tengan algún grado de retinopatía diabética, se realice un estudio exhaustivo. 
