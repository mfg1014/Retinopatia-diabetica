...
En este trabajo, se propone facilitar la labor del médico, haciendo una aplicación Android a través de la cual se realizaría un primer diagnostico del paciente a partir de una imagen que se enviará esta foto a modelos de aprendizaje computacional existentes; haciendo que los pacientes que tengan algún grado de retinopatía diabética, se realice un estudio exhaustivo. 
